"""
Sprint 2 — Saneamento e Qualidade (transform_basic.py)
=======================================================
Variante básica: ponto de partida recomendado para o Sprint 2.
Estrutura mínima para um pipeline Raw → Trusted funcional.

Use este arquivo se você está começando o Sprint 2.
Use transform_advanced.py quando quiser adicionar rastreabilidade
detalhada, logging estruturado e guardrails de qualidade.
...
Uso:
    uv run python src/transform_basic.py
"""
